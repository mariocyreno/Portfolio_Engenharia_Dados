...
# Coleta e Validação de Dados
    while True:
        try:
            ...
            if 30 <= peso <= 300:
                break
            print("⚠️ informe um peso entre 30 e 300 kg.")
        except ValueError:
    ...
    while True:
        try:
            ...
            if 100 <= altura <= 250:
                break
            print("⚠️ informe uma altura entre 100 e 250 cm.")
        except ValueError:
            print("⚠️ Digite apenas números.")
    ...
    while True:
        try:
            ...
            if 15 <= idade <= 100:
                break
            print("⚠️ informe uma idade entre 15 e 100 anos.")
        except ValueError:
            print('Digite apenas numeros inteiros (ex: 25).')
    ...
    while True:
        ...
        if nivel in fatores:
          break
        print("⚠️ Digite um número entre 1 e 5 para o nível de atividade física.")
